...
helpers_config.defaults = {
    ...
    display = {
        ...
        text_color = {150, 150, 150},       -- Default text color (RGB)
    ...
    focus = {
        require_focus_for_updates = true,   -- Only update when FFXI window is focused
    ...
    colors = {
        ...
        header = {red = 100, green = 150, blue = 255},      -- Header text color
        default_grey = {red = 128, green = 128, blue = 128}, -- Default/unknown items
        
        -- Target claim status colors
        dead_target = {red = 155, green = 155, blue = 155},         -- Dead targets
        player_claimed = {red = 255, green = 130, blue = 130},      -- Player or party claimed
        alliance_claimed = {red = 255, green = 142, blue = 205},    -- Alliance claimed
        party_member = {red = 102, green = 255, blue = 255},        -- Party member targets
        player = {red = 255, green = 255, blue = 255},              -- Other players
        npc = {red = 150, green = 225, blue = 150},                 -- Friendly NPCs
        unclaimed_mob = {red = 230, green = 230, blue = 138},       -- Unclaimed monsters
        other_claimed = {red = 153, green = 102, blue = 255},       -- Other player claimed
        
        -- Target distance colors (how far targets are from party members)
        distance_close = {red = 0, green = 255, blue = 0},          -- Very close targets
        distance_medium = {red = 255, green = 255, blue = 0},       -- Medium distance targets
        distance_far = {red = 255, green = 128, blue = 0},          -- Far targets
        distance_very_far = {red = 255, green = 0, blue = 0},       -- Very far targets
        
        -- Party member distance colors (how far party members are from party members)
        member_distance_close = {red = 50, green = 255, blue = 50},       -- Close party members
        member_distance_medium = {red = 255, green = 255, blue = 50},     -- Medium distance party members
        member_distance_far = {red = 255, green = 150, blue = 50},        -- Far party members
        member_distance_very_far = {red = 255, green = 50, blue = 50},    -- Very far party members
        
        -- Character state colors
        state_idle = {red = 128, green = 128, blue = 128},          -- Standing idle
        state_moving = {red = 100, green = 200, blue = 100},        -- Moving/walking
        state_engaged = {red = 255, green = 100, blue = 100},       -- In combat
        state_dead = {red = 64, green = 64, blue = 64},             -- Dead/unconscious
        state_mount = {red = 255, green = 255, blue = 100},         -- On mount (stationary)
        state_riding = {red = 200, green = 255, blue = 100},        -- Riding/moving on mount
        state_resting = {red = 100, green = 150, blue = 255},       -- Resting for MP/HP
        state_sitting = {red = 150, green = 150, blue = 200},       -- Sitting
        state_kneeling = {red = 150, green = 150, blue = 200},      -- Kneeling
        state_crafting = {red = 200, green = 150, blue = 100},      -- Crafting
        state_fishing = {red = 100, green = 200, blue = 255},       -- Fishing
        state_event = {red = 255, green = 200, blue = 100},         -- In cutscene/event
        state_other = {red = 200, green = 100, blue = 200}          -- Other/unknown states
    },
